...
from docforge.config import get_config
from docforge.docx import markdown_to_word
from docforge.docx.dynamic_docx_tools import register_docx_template_tools_from_yaml
from docforge.email import create_eml
from docforge.email.dynamic_email_tools import register_email_template_tools_from_yaml
from docforge.middleware import ApiKeyAuthMiddleware
from docforge.pptx import create_presentation
from docforge.xlsx import markdown_to_excel
...
LOCAL_CONFIG_PATH = Path(__file__).resolve().parent.parent / "config" / "email_templates.yaml"
...
LOCAL_DOCX_CONFIG_PATH = Path(__file__).resolve().parent.parent / "config" / "docx_templates.yaml"
...
from docforge.docx.conditional_templates import render_docx_template, render_pptx_template
...
# === Advanced PPTX Tools ===
from docforge.pptx.advanced import add_shape_to_slide, apply_slide_template, duplicate_slide
...
# === PDF Tools ===
from docforge.pdf import docx_to_pdf, markdown_to_pdf
